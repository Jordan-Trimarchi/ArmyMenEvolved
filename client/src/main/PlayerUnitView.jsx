    ...
    >
      ...
      <div>
        {targetUnit === 'ground' ? Math.round(elevation) > 1
          ...
          ) : elevation && Math.round(elevation) < 2 ? <div className="row" style={{ justifyContent: 'center' }}>{'You\'re fine.'}</div> : <div className="row" style={{ justifyContent: 'center' }}>Enter Elevation to roll for fall survival.</div> : null}
