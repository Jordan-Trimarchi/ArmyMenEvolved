const unitStats = {
  ...
  Engineer: {
    ...
    'Build Full Barrier': 'Uses 2 action. May build one full barrier(vertical wooden block) up to 5in away.',
    'Build Partial Barrier': 'Uses 1 action. May build one horizontal barrier(horizontal wooden block) up to 1in away.',
    'Relocate Full Barrier': '1 Engineer may use 2 actions or 2 engineers each using 1 action, may move a full barrier within 1in up to 5in from its current position.',
    'Relocate Partial Barrier': 'An Engineer may use 1 action to move a partial barrier within 1in up to 5in from its current location.',
